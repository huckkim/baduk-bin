...
var BadukGameRoom = /** @class */ (function () {
    ...
    BadukGameRoom.prototype.startGame = function () {
        ...
        this.black_client.on("PLAY_MOVE", function () {
            console.log("PAIN");
        });
        this.white_client.on("PLAY_MOVE", function () {
            console.log("PAIN");
        });
    };
...
var RoomManager = /** @class */ (function () {
    ...
    RoomManager.prototype.createNewGame = function (socket, size, handicap) {
        // create a new room and emit id to socket
        var roomID = uuid_1.v4();
        this.rooms.set(roomID, new BadukGameRoom_1["default"](this.server, roomID));
        socket.join(roomID);
    };
    RoomManager.prototype.joinGame = function (socket, roomID) {
        this.rooms[roomID];
    };
    return RoomManager;
}());
...
var room_manager = new RoomManager_1["default"](io);
/**
...
io.on('connection', function (socket) {
    ...
    // Create a study room
    socket.on('CREATE_STUDY', function () {
    });
    socket.on('JOIN_STUDY', function () {
    });
});
if (true) {
    module.hot.accept();
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("6354705a03001470148a")
/******/ 	})();
/******/ 	
